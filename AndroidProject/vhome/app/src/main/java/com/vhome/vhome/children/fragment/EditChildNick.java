...
public class EditChildNick extends Activity {
       ...
       bt_finish.setOnClickListener(new View.OnClickListener() {
           ...
           public void onClick(View v) {
               ...
               if(new_nickname.length() == 0){
                   Toast.makeText(EditChildNick.this,"名称不可为空",Toast.LENGTH_LONG);
               }else {
                ...
                try {
                    ...
                    if(null!=data){
                        runOnUiThread(new Runnable() {
                            ...
                            public void run() {
                                String ok = data;
                                Toast.makeText(EditChildNick.this,ok,Toast.LENGTH_SHORT);
                            }
                        });
                    }
