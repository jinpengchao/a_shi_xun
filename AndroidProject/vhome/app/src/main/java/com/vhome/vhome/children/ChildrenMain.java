 ...
 */
package com.vhome.vhome.children;
...
import com.vhome.vhome.children.fragment.LocationFragment;
import com.vhome.vhome.children.fragment.MyselfFragment;
import com.vhome.vhome.children.fragment.WarnFragment;
...
@SuppressLint("NewApi")
public class ChildrenMain extends BaseActivity {

    protected static final String TAG = "Children";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            ...
            warnFragment = (WarnFragment) getSupportFragmentManager().getFragment(savedInstanceState, WarnFragment.class.getSimpleName());
            locationFragment = (LocationFragment) getSupportFragmentManager().getFragment(savedInstanceState, LocationFragment.class.getSimpleName());
            ...
            fragments = new Fragment[]{warnFragment,locationFragment,conversationListFragment, contactListFragment, myselfFragment};
            ...
            getSupportFragmentManager().beginTransaction().add(R.id.fragment_container, warnFragment)
                    .add(R.id.fragment_container, locationFragment).hide(locationFragment)
    ...
    EMClientListener clientListener = new EMClientListener() {
        ...
        public void onMigrate2x(boolean success) {
            Toast.makeText(ChildrenMain.this, "onUpgradeFrom 2.x to 3.x " + (success ? "success" : "fail"), Toast.LENGTH_LONG).show();
            if (success) {
...
//				Toast.makeText(MainActivity.this, "All permissions have been granted", Toast.LENGTH_SHORT).show();
    ...
    private void initView() {
        ...
        mTabs = new Button[5];
        mTabs[0] = (Button) findViewById(R.id.btn_warn);
        mTabs[1] = (Button) findViewById(R.id.btn_location);
        ...
        broadcastReceiver = new BroadcastReceiver() {
            ...
            public void onReceive(Context context, Intent intent) {
                ...
                if(action.equals(Constant.ACTION_GROUP_CHANAGED)){
                    if (EaseCommonUtils.getTopActivity(ChildrenMain.this).equals(GroupsActivity.class.getName())) {
            ...
            runOnUiThread(new Runnable() {
                public void run() {
                    if (ChatActivity.activityInstance != null && ChatActivity.activityInstance.toChatUsername != null &&
                        ...
                        Toast.makeText(ChildrenMain.this, ChatActivity.activityInstance.getToChatUsername() + st10, Toast.LENGTH_LONG)
                                .show();
    ...
    private void showExceptionDialog(String exceptionType) {
        ...
        if (!ChildrenMain.this.isFinishing()) {
            // clear up global variables
            try {
                if (exceptionBuilder == null)
                    exceptionBuilder = new android.app.AlertDialog.Builder(ChildrenMain.this);
                ...
                exceptionBuilder.setPositiveButton(R.string.ok, new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        isExceptionDialogShow = false;
                        finish();
                        Intent intent = new Intent(ChildrenMain.this, com.vhome.vhome.MainActivity.class);
                ...
                DemoHelper.getInstance().logout(false,new EMCallBack() {
                    ...
                    public void onSuccess() {
                        runOnUiThread(new Runnable() {
                            public void run() {
                                finish();
                                startActivity(new Intent(ChildrenMain.this, com.vhome.vhome.MainActivity.class));
                            }
                        });
                    }
