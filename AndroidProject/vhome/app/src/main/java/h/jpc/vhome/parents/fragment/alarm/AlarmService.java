            ...
            public void run() {
                while(!flag){
                    try {
                        ...
                        //以下数据皆来自数据库
                        int[] h = new int[5];h[0]=15;h[1]=15;h[2]=15;h[3]=15;h[4]=16;
                        int[] min = new int[5];min[0]=17;min[1]=18;min[2]=48;min[3]=49;min[4]=02;
                        for (int is = 0; is < 5; is++) {
                            if (hour == h[is] && minute == min[is] && second == 00) {
                                Intent i = new Intent();
                                i.setClass(AlarmService.this, AlarmAlert.class);
                                startActivity(i);
                                Log.e("alert", "ohYeah！" + is);
                                break;
                            }
                        }
                        //设置免打扰时间
                        if(hour >= 22 && minute == 00){
                            Log.e("sleep","您要休息了。我在这给您道句晚安！");
                            break;
                        }
                        Log.e("wait","请再等等吧！！！！！");
