...
import com.vhome.chat.widget.ChatRowConferenceInvitePresenter;
import com.vhome.chat.widget.ChatRowLivePresenter;
import com.vhome.chat.widget.EaseChatRecallPresenter;
import com.vhome.chat.widget.EaseChatVoiceCallPresenter;
        ...
        titleBar.setLeftLayoutClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                if (EasyUtils.isSingleActivity(getActivity())) {
                    Intent intent = new Intent(getActivity(), ParentMain.class);
