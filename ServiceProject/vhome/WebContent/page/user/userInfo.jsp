		...
		<div class="user_left">
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" value="请叫我马哥" disabled
			...
			<div class="layui-form-item" pane="">
				...
				<div class="layui-input-block userSex">
					...
					<input type="radio" name="sex" value="女" title="女"> <input
						type="radio" name="sex" value="保密" title="保密">
				</div>
			</div>
			<div class="layui-form-item">
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block">
					<input type="text" value="" placeholder="请输入出生年月"
			...
			<div class="layui-form-item">
				...
				<div class="layui-input-block userHobby">
					...
					<input type="checkbox" name="like[html]" title="HTML(5)"> <input
						type="checkbox" name="like[css]" title="CSS(3)"> <input
						type="checkbox" name="like[php]" title="PHP"> <input
						type="checkbox" name="like[.net]" title=".net"> <input
						...
						type="checkbox" name="like[XML]" title="XML">
				</div>
			</div>
			<div class="layui-form-item">
