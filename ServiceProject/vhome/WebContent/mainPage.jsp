	...
	<div class="layui-layout layui-layout-admin">
				...
				<ul class="layui-nav top_menu">
					...
					<li class="layui-nav-item" mobile><a href="javascript:;"
						class="mobileAddTab" data-url="page/user/changePwd.jsp"><i
							class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><span>设置</span></a>
					</li>
					<li class="layui-nav-item" mobile><a
						href="page/login/login.jsp" class="signOut"><i
							class="iconfont icon-loginout"></i>退出</a></li>
					<li class="layui-nav-item lockcms" pc><a href="javascript:;"><i
							class="iconfont icon-lock1"></i>锁屏</a></li>
						...
						<dl class="layui-nav-child">
							<dd>
								<a href="javascript:;" data-url="page/user/userInfo.jsp"><i
									class="iconfont icon-zhanghu" data-icon="icon-zhanghu"></i><span>个人资料</span></a>
							</dd>
							<dd>
								<a href="javascript:;" data-url="page/user/changePwd.jsp"><i
									class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><span>修改密码</span></a>
							</dd>
							<dd>
								<a href="page/login/login.jsp" class="signOut"><i
									class="iconfont icon-loginout"></i><span>退出</span></a>
							</dd>
						</dl></li>
				</ul>
			</div>
		...
		<div class="layui-side layui-bg-black">
			<div class="user-photo">
				...
				<p>
					你好！<span class="userName">管理员昵称</span>,欢迎登录
				</p>
			</div>
			...
			<div class="layui-tab marg0" lay-filter="bodyTab" id="top_tabs_box">
				...
				<ul class="layui-nav closeBox">
					<li class="layui-nav-item"><a href="javascript:;"><i
							class="iconfont icon-caozuo"></i><span>页面操作</span></a>
						<dl class="layui-nav-child">
							<dd>
								<a href="" class="refresh refreshThis"><i class="layui-icon">&#x1002;</i><span>刷新当前</span></a>
							</dd>
							<dd>
								<a href="" class="closePageOther"><i
									class="iconfont icon-prohibit"></i><span>关闭其他</span></a>
							</dd>
							<dd>
								<a href="" class="closePageAll"><i
									class="iconfont icon-guanbi"></i><span>关闭全部</span></a>
							</dd>
						</dl></li>
				</ul>
