...
/**
 * Servlet implementation class FindMyRelation
 */
@WebServlet("/FindMyRelation")
public class FindMyRelation extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public FindMyRelation() {
        super();
