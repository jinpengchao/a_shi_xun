			...
			<div class="layui-main">
			    ...
			    <ul class="layui-nav top_menu">
			    	<li class="layui-nav-item showNotice" id="showNotice" pc>
						<a href="javascript:;"><i class="iconfont icon-gonggao"></i><cite>ç³»ç»å¬å</cite></a>
					</li>
			    	...
			    	<li class="layui-nav-item" mobile>
			    		<a href="page/login/login.html" class="signOut"><i class="iconfont icon-loginout"></i> éåº</a>
			    	</li>
					...
					<li class="layui-nav-item" pc>
						...
						<dl class="layui-nav-child">
							...
							<dd><a href="javascript:;" data-url="page/user/changePwd.html"><i class="iconfont icon-shezhi1" data-icon="icon-shezhi1"></i><cite>ä¿®æ¹å¯ç </cite></a></dd>
							<dd><a href="javascript:;" class="changeSkin"><i class="iconfont icon-huanfu"></i><cite>æ´æ¢ç®è¤</cite></a></dd>
							<dd><a href="page/login/login.html" class="signOut"><i class="iconfont icon-loginout"></i><cite>éåº</cite></a></dd>
						</dl>
					</li>
				</ul>
			</div>
